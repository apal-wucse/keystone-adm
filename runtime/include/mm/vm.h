...
static inline pte ptd_create(uintptr_t ppn) { return pte_create(ppn, PTE_V); }
...
static inline uintptr_t pte_ppn(pte pte) { return pte >> PTE_PPN_SHIFT; }

#ifndef LOADER_BIN
static inline uintptr_t __adm_offset(uintptr_t va) {
