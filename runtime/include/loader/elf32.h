...
static inline bool elf_isElf32(elf_t* elf) { return elf->elfClass == ELFCLASS32; }

static inline Elf32_Ehdr elf32_getHeader(elf_t* elf) { return *(Elf32_Ehdr*)elf->elfFile; }

static inline uintptr_t elf32_getEntryPoint(elf_t* elf) { return elf32_getHeader(elf).e_entry; }
...
static inline size_t elf32_getNumProgramHeaders(elf_t* elf) { return elf32_getHeader(elf).e_phnum; }

static inline size_t elf32_getNumSections(elf_t* elf) { return elf32_getHeader(elf).e_shnum; }
