...
static inline bool elf_isElf64(elf_t* elf) { return elf->elfClass == ELFCLASS64; }

static inline Elf64_Ehdr elf64_getHeader(elf_t* elf) { return *(Elf64_Ehdr*)elf->elfFile; }

static inline uintptr_t elf64_getEntryPoint(elf_t* file) { return elf64_getHeader(file).e_entry; }
...
static inline size_t elf64_getNumSections(elf_t* elf) { return elf64_getHeader(elf).e_shnum; }
