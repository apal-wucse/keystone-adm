...
extern unsigned long __asm_copy_to_user(void* to, const void* from, unsigned long n);
extern unsigned long __asm_copy_from_user(void* to, const void* from, unsigned long n);
