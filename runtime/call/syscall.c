...
uintptr_t dispatch_edgecall_ocall(
    unsigned long call_id, void* data, size_t data_len, void* return_buffer, size_t return_len) {
    uintptr_t ret;
    /* For now we assume by convention that the start of the buffer is
     * the right place to put calls */
    struct edge_call* edge_call = (struct edge_call*)shared_buffer;
...
uintptr_t dispatch_edgecall_syscall_protected(
    ...
    if (allow_write) {
        ...
        ret = sbi_stop_enclave_with_share((uintptr_t)type_info, region_n, ADM_SHARE_RW);
...
uintptr_t dispatch_edgecall_ocall_with_share(
    unsigned long call_id, void* retbuf, size_t retbuf_len, uintptr_t type_info, size_t count,
    ...
    /* TODO This is currently assuming return_len is the length, not the
       ...
       almost certainly.*/
    copy_to_user(
        retbuf, (void*)return_ptr, ret_len_untrusted > retbuf_len ? retbuf_len : ret_len_untrusted);
...
void init_edge_internals() { edge_call_init_internals(shared_buffer, shared_buffer_size); }
...
uintptr_t handle_map_adm(void* size) {
...
void handle_syscall(struct encl_ctx* ctx) {
    ...
    case (RUNTIME_SYSCALL_OCALL_SHARE):
        ret = dispatch_edgecall_ocall_with_share(arg0, (void*)arg1, arg2, arg3, arg4, arg5);
        break;
#ifdef USE_LINUX_SYSCALL
    ...
    case (SYS_mmap):
        ret =
            syscall_mmap((void*)arg0, (size_t)arg1, (int)arg2, (int)arg3, (int)arg4, (__off_t)arg5);
        break;
    ...
    case (SYS_renameat2):
        ret =
            io_syscall_renameat2((int)arg0, (uintptr_t)arg1, (int)arg2, (uintptr_t)arg3, (int)arg4);
        break;
    case (SYS_umask):
    ...
    case (SYS_recvfrom):
        ret = io_syscall_recvfrom(
            (int)arg0, (uintptr_t)arg1, (int)arg2, (int)arg3, (uintptr_t)arg4, (uintptr_t)arg5);
        break;
    case (SYS_sendto):
        ret = io_syscall_sendto(
            (int)arg0, (uintptr_t)arg1, (int)arg2, (int)arg3, (uintptr_t)arg4, (int)arg5);
        break;
    case (SYS_sendfile):
    ...
    case (SYS_pselect6):
        ret = io_syscall_pselect(
            (int)arg0, (uintptr_t)arg1, (uintptr_t)arg2, (uintptr_t)arg3, (uintptr_t)arg4,
            (uintptr_t)arg5);
        break;
#endif /* USE_NET_SYSCALL */
