 ...
 *                  long)!
 */
static void prepare_key(const unsigned char *key, int key_len, unsigned char *new_key) {
    sha3_ctx_t ctx;
 ...
 */
void hmac_sha3(
    const unsigned char *key, int key_len, const unsigned char *text, int text_len,
    unsigned char *hmac) {
    hmac_sha3_ctx_t ctx;
 ...
 *      key_len:    Size of the key
 */
void hmac_sha3_init(hmac_sha3_ctx_t *ctx, const unsigned char *key, int key_len) {
 ...
 *      text_len:   Size of the message
 */
void hmac_sha3_update(hmac_sha3_ctx_t *ctx, const unsigned char *text, int text_len) {
    if (text_len > 0)
