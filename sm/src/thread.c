...
void swap_prev_state(
    struct thread_state *thread, struct sbi_trap_regs *regs, int return_on_resume) {
    int i;
...
void swap_prev_mepc(
    struct thread_state *thread, struct sbi_trap_regs *regs, uintptr_t current_mepc) {
