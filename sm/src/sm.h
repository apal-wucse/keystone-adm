...
#define SBI_SM_STOP_ENCLAVE_SHARE 3007 // For Edge Protection
...
#define SBI_ERR_SM_ENCLAVE_ADM_ILLEGAL_DATA 100017
...
struct runtime_va_params_t {
    ...
    uintptr_t untrusted_ptr; // Deprecated: expect always zero
    uintptr_t untrusted_size;
    uintptr_t additional_ptr; // Deprecated: expect always zero
...
struct keystone_sbi_create {
    ...
    struct keystone_sbi_pregion adm_region;
