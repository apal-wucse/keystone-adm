 ...
 * ADM is the shared region with some protection by PMP
...
struct enclave {
    ...
    /* For ADM Validation */
    AdmProtect adm_default_protection;
    AdmState adm_state_info;
};
...
unsigned long
get_sealing_key(uintptr_t seal_key, uintptr_t key_ident, size_t key_ident_size, enclave_id eid);
#endif
