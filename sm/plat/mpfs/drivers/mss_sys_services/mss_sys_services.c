...
uint16_t MSS_SYS_get_serial_number(uint8_t* p_serial_number, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_SERIAL_NUMBER_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_serial_number, (uint16_t)MSS_SYS_SERIAL_NUMBER_RESP_LEN, mb_offset,
...
uint16_t MSS_SYS_get_user_code(uint8_t* p_user_code, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_USERCODE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_user_code, (uint16_t)MSS_SYS_USERCODE_RESP_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_USERCODE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_user_code, (uint16_t)MSS_SYS_USERCODE_RESP_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
...
uint16_t MSS_SYS_get_design_info(uint8_t* p_design_info, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_DESIGN_INFO_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_design_info, (uint16_t)MSS_SYS_DESIGN_INFO_RESP_LEN, mb_offset,
            MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_DESIGN_INFO_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
uint16_t MSS_SYS_get_device_certificate(uint8_t* p_device_certificate, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_DEVICE_CERTIFICATE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_device_certificate, (uint16_t)MSS_SYS_DEVICE_CERTIFICATE_RESP_LEN, mb_offset,
            MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_DEVICE_CERTIFICATE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
uint16_t MSS_SYS_read_digest(uint8_t* p_digest, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_READ_DIGEST_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_digest, (uint16_t)MSS_SYS_READ_DIGEST_RESP_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_READ_DIGEST_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_digest, (uint16_t)MSS_SYS_READ_DIGEST_RESP_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
...
uint16_t MSS_SYS_query_security(uint8_t* p_security_locks, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_QUERY_SECURITY_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA, buf,
            (uint16_t)(MSS_SYS_QUERY_SECURITY_RESP_LEN + 3u), mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_QUERY_SECURITY_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA, buf,
            (uint16_t)(MSS_SYS_QUERY_SECURITY_RESP_LEN + 3u), mb_offset, MSS_SYS_COMMON_RET_OFFSET);
...
uint16_t MSS_SYS_read_debug_info(uint8_t* p_debug_info, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_READ_DEBUG_INFO_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_debug_info, (uint16_t)MSS_SYS_READ_DEBUG_INFO_RESP_LEN, mb_offset,
            MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_READ_DEBUG_INFO_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
uint16_t MSS_SYS_read_envm_parameter(uint8_t* p_envm_param, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_READ_ENVM_PARAM_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_envm_param, (uint16_t)MSS_SYS_READ_ENVM_PARAM_RESP_LEN, mb_offset,
            MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_READ_ENVM_PARAM_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
uint16_t MSS_SYS_puf_emulation_service(
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_PUF_EMULATION_SERVICE_REQUEST_CMD, mb_format,
            (uint16_t)MSS_SYS_PUF_EMULATION_SERVICE_CMD_LEN, p_response,
            (uint16_t)MSS_SYS_PUF_EMULATION_SERVICE_RESP_LEN, mb_offset,
...
uint16_t MSS_SYS_digital_signature_service(
    ...
    if (format == MSS_SYS_DIGITAL_SIGNATURE_RAW_FORMAT_REQUEST_CMD) {
        if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
            status = execute_ss_interrupt_mode(
                (uint8_t)MSS_SYS_DIGITAL_SIGNATURE_RAW_FORMAT_REQUEST_CMD, p_hash,
                (uint16_t)MSS_SYS_DIGITAL_SIGNATURE_HASH_DATA_LEN, p_response,
                (uint16_t)MSS_SYS_DIGITAL_SIGNATURE_RAW_FORMAT_RESP_SIZE, mb_offset,
        ...
        if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
            status = execute_ss_interrupt_mode(
                (uint8_t)MSS_SYS_DIGITAL_SIGNATURE_DER_FORMAT_REQUEST_CMD, p_hash,
                (uint16_t)MSS_SYS_DIGITAL_SIGNATURE_HASH_DATA_LEN, p_response,
                (uint16_t)MSS_SYS_DIGITAL_SIGNATURE_DER_FORMAT_RESP_SIZE, mb_offset,
                (uint16_t)MSS_SYS_DIGITAL_SIG_RET_OFFSET);
        } else {
            status = execute_ss_polling_mode(
                (uint8_t)MSS_SYS_DIGITAL_SIGNATURE_DER_FORMAT_REQUEST_CMD, p_hash,
...
uint16_t MSS_SYS_secure_nvm_write(
    ...
    *p_frame = snvm_module; /*SNVMADDR - SNVM module*/
    ...
    if ((format == MSS_SYS_SNVM_AUTHEN_TEXT_REQUEST_CMD) ||
        ...
        /* Copy user data */
        for (index = 0u;
             index < (MSS_SYS_AUTHENTICATED_TEXT_DATA_LEN - MSS_SYS_USER_SECRET_KEY_LEN); index++) {
        ...
        if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
            status = execute_ss_interrupt_mode(
                format, &frame[0], (uint16_t)MSS_SYS_AUTHENTICATED_TEXT_DATA_LEN, NULL_BUFFER,
        ...
        /* Copy user data */
        for (index = 0u; index < (MSS_SYS_NON_AUTHENTICATED_TEXT_DATA_LEN - 4u); index++) {
            *(p_frame + index) = p_data[index];
        }

        if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
            status = execute_ss_interrupt_mode(
                format, &frame[0], (uint16_t)MSS_SYS_NON_AUTHENTICATED_TEXT_DATA_LEN, NULL_BUFFER,
                MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
        } else {
            status = execute_ss_polling_mode(
                format, &frame[0], (uint16_t)MSS_SYS_NON_AUTHENTICATED_TEXT_DATA_LEN, NULL_BUFFER,
...
uint16_t MSS_SYS_secure_nvm_read(
    ...
    *p_frame = snvm_module; /*SNVMADDR - SNVM module*/
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_SNVM_READ_REQUEST_CMD, &frame[0],
            (uint16_t)MSS_SYS_SECURE_NVM_READ_DATA_LEN, response, (data_len + 4u), mb_offset,
...
uint16_t MSS_SYS_nonce_service(uint8_t* p_nonce, uint16_t mb_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_NONCE_SERVICE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            p_nonce, (uint16_t)MSS_SYS_NONCE_SERVICE_RESP_LEN, mb_offset,
            MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_NONCE_SERVICE_REQUEST_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
/***************************************************************************/ /**
                                                                               ...
                                                                               */
uint16_t
MSS_SYS_execute_uic_script(uint8_t src_periph_type, uint32_t periph_address, uint16_t mb_offset) {
    uint16_t status = MSS_SYS_PARAM_ERR;
    ...
    if (src_periph_type == MSS_SYS_UIC_SOURCE_PERIPH_SNVM) {
        ...
        (src_periph_type == MSS_SYS_UIC_SOURCE_PERIPH_NONAUTHEN_SPIFLASH) ||
    ...
    *(uint32_t*)input_data = l_periph_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_UIC_EXECUTE_SCRIPT_CMD, &input_data[0],
            (uint16_t)MSS_SYS_EXECUTE_UIC_SCRIPT_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
...
uint16_t MSS_SYS_authenticate_iap_image(uint32_t spi_idx) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_BITSTREAM_AUTHENTICATE_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, (uint16_t)spi_idx, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_BITSTREAM_AUTHENTICATE_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, (uint16_t)spi_idx, MSS_SYS_COMMON_RET_OFFSET);
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * function.
                                                                               */
uint16_t MSS_SYS_spi_copy(
    uint64_t mss_dest_addr, uint32_t mss_spi_flash, uint32_t n_bytes, uint8_t options,
    uint16_t mb_offset) {
    uint16_t status = MSS_SYS_PARAM_ERR;
    ...
    *(uint32_t*)(mb_format + 12u) = n_bytes;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_SPI_COPY_CMD, mb_format, (uint16_t)MSS_SYS_SPI_COPY_MAILBOX_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_SPI_COPY_CMD, mb_format, (uint16_t)MSS_SYS_SPI_COPY_MAILBOX_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
...
uint16_t MSS_SYS_debug_read_probe(
    ...
    *(uint16_t*)mb_format = service_data;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_PROBE_READ_DEBUG_CMD, mb_format,
            (uint16_t)MSS_SYS_PROBE_READ_SERVICE_DATA_LEN, prdata,
            (uint16_t)MSS_SYS_PROBE_READ_SERVICE_RESP_LEN, mb_offset, (uint16_t)l_resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_PROBE_READ_DEBUG_CMD, mb_format,
            (uint16_t)MSS_SYS_PROBE_READ_SERVICE_DATA_LEN, prdata,
...
uint16_t MSS_SYS_debug_write_probe(
    ...
    *(uint32_t*)(mb_format + 8u) = pwdata;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_PROBE_WRITE_DEBUG_CMD, mb_format,
            (uint16_t)MSS_SYS_PROBE_WRITE_SERVICE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_PROBE_WRITE_DEBUG_CMD, mb_format,
...
uint16_t MSS_SYS_debug_live_probe(
    ...
    *(uint32_t*)mb_format = service_data;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            service_cmd, mb_format, (uint16_t)MSS_SYS_LIVE_PROBE_DEBUG_SERVICE_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            service_cmd, mb_format, (uint16_t)MSS_SYS_LIVE_PROBE_DEBUG_SERVICE_DATA_LEN,
...
uint16_t MSS_SYS_debug_select_mem(
    ...
    *(uint16_t*)(mb_format + 4u) = timeout;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_MEM_SELECT_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_MEM_SELECT_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_MEM_SELECT_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_MEM_SELECT_DATA_LEN,
...
MSS_SYS_debug_read_mem(uint16_t mem_addr, uint16_t n_words, uint64_t mss_addr, uint16_t mb_offset) {
    ...
    *(uint64_t*)(mb_format + 8u) = mss_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_MEM_READ_DEBUG_CMD, mb_format,
            (uint16_t)MSS_SYS_MEM_READ_WRITE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_MEM_READ_DEBUG_CMD, mb_format,
...
uint16_t MSS_SYS_debug_write_mem(
    ...
    *(uint64_t*)(mb_format + 8u) = mss_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_MEM_WRITE_DEBUG_CMD, mb_format,
            (uint16_t)MSS_SYS_MEM_READ_WRITE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
...
uint16_t MSS_SYS_debug_read_apb(
    ...
    *(uint64_t*)(mb_format + 16u) = mss_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_APB_READ_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_APB_SERVICE_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_APB_READ_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_APB_SERVICE_DATA_LEN,
...
uint16_t MSS_SYS_debug_write_apb(
    ...
    *(uint64_t*)(mb_format + 16u) = mss_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_APB_WRITE_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_APB_SERVICE_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_APB_WRITE_DEBUG_CMD, mb_format, (uint16_t)MSS_SYS_APB_SERVICE_DATA_LEN,
...
MSS_SYS_debug_fabric_snapshot(uint32_t port_addr, uint8_t apb_fast_write, uint16_t mb_offset) {
    ...
    *(uint32_t*)mb_format = port_addr;
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_DEBUG_SNAPSHOT_CMD, mb_format,
            (uint16_t)MSS_SYS_DEBUG_SNAPSHOT_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, MSS_SYS_COMMON_RET_OFFSET);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_DEBUG_SNAPSHOT_CMD, mb_format,
...
uint16_t MSS_SYS_otp_generate(
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_GENERATE_OTP_CMD, mb_format, (uint16_t)MSS_SYS_GENERATE_OTP_DATA_LEN,
            n_fpga, (uint16_t)MSS_SYS_GENERATE_OTP_RESP_LEN, mb_offset, resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_GENERATE_OTP_CMD, mb_format, (uint16_t)MSS_SYS_GENERATE_OTP_DATA_LEN,
            n_fpga, (uint16_t)MSS_SYS_GENERATE_OTP_RESP_LEN, mb_offset, resp_offset);
...
uint16_t MSS_SYS_otp_match(
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_MATCH_OTP_CMD, mb_format, (uint16_t)MSS_SYS_MATCH_OTP_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_MATCH_OTP_CMD, mb_format, (uint16_t)MSS_SYS_MATCH_OTP_DATA_LEN,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, resp_offset);
...
MSS_SYS_unlock_debug_passcode(uint8_t* cmd_data, uint16_t mb_offset, uint16_t resp_offset) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_UNLOCK_DEBUG_PASSCODE, cmd_data,
            (uint16_t)MSS_SYS_UNLOCK_DEBUG_PASSCODE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_UNLOCK_DEBUG_PASSCODE, cmd_data,
            (uint16_t)MSS_SYS_UNLOCK_DEBUG_PASSCODE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
...
uint16_t MSS_SYS_one_way_passcode(
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_ONE_WAY_PASSCODE_CMD, mb_format,
            (uint16_t)MSS_SYS_ONE_WAY_PASSCODE_DATA_LEN, NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN,
            mb_offset, resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_ONE_WAY_PASSCODE_CMD, mb_format,
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * function.
                                                                               */
uint16_t MSS_SYS_debug_terminate(uint16_t mb_offset, uint16_t resp_offset) {
    uint16_t status = MSS_SYS_PARAM_ERR;

    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        status = execute_ss_interrupt_mode(
            (uint8_t)MSS_SYS_TERMINATE_DEBUG_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
            NULL_BUFFER, MSS_SYS_NO_RESPONSE_LEN, mb_offset, resp_offset);
    } else {
        status = execute_ss_polling_mode(
            (uint8_t)MSS_SYS_TERMINATE_DEBUG_CMD, NULL_BUFFER, MSS_SYS_WITHOUT_CMD_DATA,
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * function.
                                                                               */
uint16_t MSS_SYS_read_response(void) {
    ...
    if (g_message_interrupt_counter > 0u) {
        ...
        if (g_int_service_response_size > 0u) {
            response_limit = g_int_service_response_size + g_int_service_response_offset;
        ...
        status =
            ((MSS_SCBCTRL->SERVICES_SR & SCBCTRL_SERVICESSR_STATUS_MASK) >>
    ...
    *MSS_SCBMESSAGE_INT = 0x0u; /*clear message_int reg*/
    ...
    if (cmd_data_size > 0u) {
        ...
        if ((cmd_data_size % 4u) > 0u) {
            ...
            for (byte_index = 0u; byte_index < (cmd_data_size % 4u); byte_index++) {
    ...
    if (MSS_SYS_SERVICE_INTERRUPT_MODE == g_service_mode) {
        MSS_SCBCTRL->SERVICES_CR =
            (((ss_command << SCBCTRL_SERVICESCR_COMMAND) & SCBCTRL_SERVICESCR_COMMAND_MASK) |
...
static uint16_t execute_ss_polling_mode(
    ...
    if (status == MSS_SYS_SUCCESS) {
         ...
         * command*/
        while (SCBCTRL_SERVICESCR_REQ_MASK ==
               (MSS_SCBCTRL->SERVICES_CR & SCBCTRL_SERVICESCR_REQ_MASK)) {
            ;
        }
        ...
        while (SCBCTRL_SERVICESSR_BUSY_MASK ==
               (MSS_SCBCTRL->SERVICES_SR & SCBCTRL_SERVICESSR_BUSY_MASK)) {
            ;
        }
