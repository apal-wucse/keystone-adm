...
macro(use_riscv_toolchain bits)
  ...
  if (NOT "${ERROR}" STREQUAL 0)
    message(FATAL_ERROR "RISCV Toolchain is not found - ${cross_compile}")
  endif()
...
macro(add_eyrie_runtime target_name plugins) # the files are passed via ${ARGN}
  ...
  ExternalProject_Add(eyrie-${target_name}
    ...
    DOWNLOAD_COMMAND rm -rf ${eyrie_src} && cp -ar ${KEYSTONE_EYRIE_RUNTIME} ${eyrie_src} && chmod -R u+w ${eyrie_src}
